...
const { findById, aggregate } = require("../models/product");
...
exports.productStar = async (req, res) => {
    ...
    // check if currently logged in user have alredy added rating to this product
    let existingRatingObject = product.ratings.find((ele) => (ele.postedBy.toString() === user._id.toString()))

    // if user haven't left rating yet, push it
    if (existingRatingObject === undefined) {
        let raitingAdded = await Product.findByIdAndUpdate(product._id, {
